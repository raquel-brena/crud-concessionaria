...
OBJECTS=build/sistema.o build/executor.o build/carro.o build/concessionaria.o build/veiculo.o build/caminhao.o build/moto.o build/apoioConcessionaria.o
...
build/concessionaria.o: src/concessionaria.cpp include/concessionaria.h Include/apoioConcessionaria.h 
	g++ -Iinclude src/concessionaria.cpp -c -o build/concessionaria.o build/apoioConcessionaria.o 
...
meuMake: 
	g++ -o programa -Iinclude -Wall -pedantic src/*.cpp

run2:
	.\programa.exe < ./entradas/test1.txt
